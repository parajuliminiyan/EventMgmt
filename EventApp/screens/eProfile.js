...
export default  class EProfile extends Component
{
   ...
   async componentDidMount()
   {
       ...
       data.id == undefined ? data = data[0] : data = data;
       this.setState({id:data.id,name:data.fullname,website:data.webite, affiliation:data.affiliation,email:data.email,contactNo:data.contactNo,dbPassword:data.password,address:data.address,phoneNumber:data.phoneNumber});
   ...
   .then( async(res)=> {
     if(res.status == 'Error')
     {
       ...
       Toast.show({
         ...
         await AsyncStorage.setItem('userData',JSON.stringify(res.data)).then(()=>{
                       ...
                       <Form>
                           ...
                           <CardItem>
                                   <FormItem floatingLabel>
                                       ...
                                       <Input keyboardType="numeric" value={this.state.phoneNumber} onChangeText={(text)=>this.setState({phoneNumber:text})} />
                                   </FormItem>
                           </CardItem>
                           <CardItem>
                                   <FormItem floatingLabel>
                           ...
                           <CardItem>
                                   <FormItem floatingLabel>
                                       ...
                                       <Input value={this.state.affiliation} onChangeText={(text)=>this.setState({affiliation:text})} />
                                   </FormItem>
                           </CardItem>
                           <CardItem>
                                   <FormItem floatingLabel>
